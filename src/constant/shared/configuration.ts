...
import { BORDER_POSITION_MASK, BORDER_POSITION_VARIATION, CONFIG_SECTION_KEY, DECORATION_GENERAL_STYLE_CONFIG_KEY, DECORATION_SELECTION_STYLE_CONFIG_KEY, DECORATION_STYLE_CONFIG_KEY, DECORATION_TYPE_MASK, DIAGNOSTIC_SEVERITY_KEY, DIAGNOSTIC_TEXT_STYLE_KEY, SELECTION_CONTENT_TEXT_CONFIG_KEY } from '../string/enum.configuration';
import { SCM_SVG_ICON_PATH } from '../string/enum.runtime';
...
export const CONFIG_SECTION = {
    ...
    [CONFIG_SECTION_KEY.SCM_TEXT]: CONFIG_SECTION_KEY.SCM_TEXT
} as const;
...
export const CONFIG_KEY_LINKER_SECTION_CONFIG = {
    ...
    scmTextEnabled: ['scmText', 'enabled'],
};
