...
var contentTextFuncBuffered = (setDecorations, buffer, channel, countBuffer) => (decorationType, idx) => {
  ...
  if (typeof decorationType.after.contentText !== "string") {
    ...
    if (countBuffer[hexKey] === -1) {
      countBuffer[hexKey] = multilineFunctionSymLink[hexKey](vscode3.window.activeTextEditor);
    }
...
var multilineSelection = (editor2, previousKey) => {
  ...
  optionBufferChannel[0][0] = { ...optionGrid, range: createLineRange(editor2.selection.anchor) };
  optionBufferChannel[1][0] = { ...optionGrid, range: createLineRange(editor2.selection.active) };
